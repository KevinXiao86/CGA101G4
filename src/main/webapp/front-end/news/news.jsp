...
<%@page import="com.taiwan.service.news.*"%>
                        ...
                        <div class="single-blog">
                            ...
                            <div class="middel-box fix">
                                <ul class="blog-footer floatleft">
                                    <li><i class="fa fa-calendar"></i><a href="#"><fmt:formatDate value="${news.createDate}"	pattern="yyyy-MM-dd HH:mm" /></a></li>
                                </ul>
                            </div>
                            <div class="bolg-content"><a href="#">${news.title}</a>
                                <p>
                                	${news.content}
                                </p>
                            </div>
