...
<table id="table-1">
	<tr><td>
		 ...
		 <h4><a href="back-end/emp/select_page.jsp"><img src="back-end/emp/images/tomcat.png" width="100" height="100" border="0">回首頁</a></h4>
	</td></tr>
</table>
...
<table>
	<tr>
		...
		<td><input type="TEXT" name="empName" size="45" 
			 value="${param.empName}"/></td><td>${errorMsgs.empName}</td>
	</tr>
	<tr>
		<td>員工密碼:</td>
		<td><input type="TEXT" name="empPassword" size="45"
			 value="${param.empPassword}"/></td><td>${errorMsgs.empPassword}</td>
	</tr>
<!-- 	<tr> -->
<!-- 		<td>狀態:</td> -->
