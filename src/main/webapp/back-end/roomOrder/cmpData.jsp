...
<body>
	<label for="cmp_name">廠商名稱:</label>
		...
		<textarea rows="6" cols="40" name="cmpIntroduce" id="cmp_introduce" readonly="readonly">${company.cmpIntroduce} </textarea><br>
		...
		<textarea rows="6" cols="40" name="notice" id="notice" readonly="readonly">${company.notice}</textarea><br>

		<label for="canx">取消政策:</label>
		<textarea rows="6" cols="40" name="canx" id="canx" readonly="readonly">${company.canx}</textarea><br>
