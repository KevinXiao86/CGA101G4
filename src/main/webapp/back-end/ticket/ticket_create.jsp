			...
			<div class="row">
			 ...
			 <div id="tkt_form">
                    <form action="ticket/ticketCreator" method="post"	enctype="multipart/form-data">
                        ...
                        <span>票券數量</span><input name="originalAmount" type="number"	min="0" placeholder="請輸入票券數量" value="${(param.originalAmount == null)? 10000: param.originalAmount}">${errorMsgs.originalAmount}<br>
                        <span>票券價格</span><input name="price" type="number" min="0"	placeholder="請輸入票券價格" value="${param.price}">${errorMsgs.price}<br>
