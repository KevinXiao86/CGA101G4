			...
			<div class="row">
			 ...
			 <div id="tkt_form">
                    <form action="ticket/ticketCreator" method="post"	enctype="multipart/form-data">
                        <span>票券名稱:</span><br>
                        <input name="tktName" type="text" autofocus	placeholder="請輸入票券名稱" value="${param.tktName}">${errorMsgs.tktName}<br>
                        <span>票券數量:</span><br>
                        <input name="originalAmount" type="number"	min="0" placeholder="請輸入票券數量" value="${(param.originalAmount == null)? 10000: param.originalAmount}">${errorMsgs.originalAmount}<br>
                        <span>票券價格:</span><br>
                        <input name="price" type="number" min="0"	placeholder="請輸入票券價格" value="${param.price}">${errorMsgs.price}<br>
                        <span>票券開始日期:</span><br>
                        <input name="startdate" id="startdate"	type="datetime-local" value="2022-01-01T08:00"><br> 
                        <span>票券結束日期:</span><br>
                        <input name="enddate" id="enddate" type="datetime-local" value="2022-12-31T22:00">${errorMsgs.timeError}<br> <span>種類</span>
