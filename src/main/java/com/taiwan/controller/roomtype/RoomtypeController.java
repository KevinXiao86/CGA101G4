...
//				System.out.println(roomtypeId);
				...
				String roomtypePath = servletContext
						.getRealPath("/images/Company/" + company.getCmpAccount() + File.separator + roomtypeId);
...
//					System.out.println("images" + File.separator + "Company" + File.separator + company.getCmpAccount() + File.separator + roomtypeId + File.separator + fileName);
					// 為 RoomImg 設置保存路徑
					String savePath = "images" + File.separator + "Company" + File.separator + company.getCmpAccount()
							+ File.separator + roomtypeId + File.separator + fileName;
...
//		System.out.println(result);
	...
	public void getCompanyByModelAttribute(@RequestParam(value = "cmpId", required = false) String cmpId,
		...
		model.addAttribute("modelAttributeRoomtype", roomtype);
		System.out.println("ModelAttribute" + roomtype);
	}

	// 房型資料修改
	@RequestMapping("/editRoomtype")
	public String editRoomtype(@RequestParam("file") MultipartFile[] files, HttpServletRequest request,
			HttpSession session, Model model) throws IOException, ServletException {
...
//				System.out.println(fileName);
				...
				// 獲取服務器中 images/Company/廠商帳號/房型編號 目錄的路徑
				// 獲取當前的 roomtypeId
				int roomtypeId = roomtypeService.getRoomtypeId();
				// 為 RoomImg 設置 roomtypeId
				roomImg.setRoomtypeId(roomtypeId);
				roomtype.setRoomtypeId(roomtypeId);
//				System.out.println(roomtypeId);
...
//		}
		...
		// 調用 service 業務方法
		boolean result = roomtypeService.updateRoomtypeByRoomtypeId(roomtype);
		boolean res = roomtypeService.updateRoomImg(imgs);
//		System.out.println(result);
