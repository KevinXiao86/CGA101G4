...
public class jdbcUtil_CompositeQuery_Room {
	...
	public static String get_aCondition_For_myDB(String columnName, String value) {
		...
		if ( "cmp_id".equals(columnName) || "PRICE".equals(columnName) ) // 用於其他
			aCondition = columnName + "=" + value;
		else if ("cmp_name".equals(columnName) || "location".equals(columnName)|| "KIND".equals(columnName)) // 用於varchar  status 
